        ...
        <ul className="space-y-1" id="_socialMediaUL">
          <li className="flex space-x-3 justify-end">
            <span className="text-[18px] font-medium text-black">
              {socData && socData.email?socData.email:'social-links ("Click Me")'}
            </span>
            <div className="icon">
              <svg
          ...
          {socData && socData.personalWebsite && (
              <li className="flex space-x-3 justify-end">
              <span className="text-[18px] font-medium text-black">
                {socData.personalWebsite}
              </span>
              <div className="icon">
                <svg
                  className="h-7 w-7"
